...
@app.route('/planet_add_obj', methods=['POST'])
@jwt_required()
def planet_add_obj():
...
@app.route('/planet_update_obj', methods=['PUT'])
@jwt_required()
def planet_update_obj():
...
@app.route('/planet_remove_obj/<int:planet_id>', methods=['DELETE'])
@jwt_required()
def planet_remove_obj(planet_id: int):
    planet = Planet.query.filter_by(planet_id=planet_id).first()
    if planet:
